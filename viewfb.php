   ...
   ?>
    <body>
      ...
      <div class="yellow-bg">
        ...
        <h1 class="welcome-txt">_____________________________________View Patient Feedback_____________________________________</h1>
        ...
        <div class="red-bg to-txt" style="padding-left:200px">
                ...
                <?php
                    ...
                    $sql = "SELECT feedback, fbdate FROM feedback";
                    $result = $con->query($sql);
                    if ($result->num_rows > 0) // output data of each row
                    {                    
                        while($row = $result->fetch_assoc()) 
                        {
                          echo "</td><td>".$row["feedback"]."</td><td>".$row["fbdate"]. "</td></tr>";
                        }
                        echo "</table>";
                    } 
                    else 
